...
export const exercises: Exercise[] = [
  ...
  },
  {
    ...
    setup: [
      ...
      "Sit with back fully against the pad and feet flat on the floor.",
    ],
    instructions: [
      "Grip the handles, press forward until arms are extended.",
      "Return slowly to the start position with control.",
    ],
    execution: [
      "Keep shoulder blades retracted throughout.",
      "Don't lock elbows aggressively at full extension.",
      "Control the weight on the return — don't let the stack crash.",
    ],
    breathing: "Exhale pressing forward, inhale on the return.",
    tempo: "2 seconds out, 2 seconds back.",
    commonMistakes: ["Seat too high causing shoulder impingement", "Losing upper back tension", "Bouncing at the start position"],
    safetyTips: ["Adjust seat height before loading weight.", "Stop if shoulder impingement occurs."],
    progressionTips: ["Great machine for beginners to learn chest pressing mechanics.", "Progress to free-weight pressing as strength develops."],
    aliases: ["chest press machine", "machine press", "pec deck press", "seated chest press"],
  },
  {
    ...
    difficulty: "beginner",
    setup: [
      "Attach a close-grip neutral handle to the pulldown cable.",
      "Sit with thighs secured under pads, arms extended overhead.",
    ],
    instructions: [
      "Pull the handle toward your upper chest, driving elbows down and back.",
      "Squeeze shoulder blades together at the bottom, return slowly.",
    ],
    execution: [
      "Lean back slightly — about 10–15 degrees.",
      "Lead with your elbows, not your hands.",
      "Lower the weight fully to stretch the lats on each rep.",
    ],
    breathing: "Exhale pulling down, inhale releasing.",
    tempo: "2 seconds down, 3 seconds up.",
    commonMistakes: ["Using momentum and swinging", "Not getting full range of motion", "Pulling with biceps instead of lats"],
    safetyTips: ["Start with a manageable weight to learn the lat activation.", "Avoid pulling behind the neck."],
    progressionTips: ["Neutral grip reduces bicep dominance and isolates lats better.", "Progress to pull-ups when you can pull bodyweight."],
    aliases: ["neutral grip pulldown", "close grip lat pulldown", "hammer grip pulldown", "parallel grip pulldown"],
  },
  {
    ...
    execution: [
      "Keep core braced and lower back pressed into the seat.",
      "Don't hyperextend the lower back at lockout.",
      "Bring dumbbells together slightly at the top.",
    ],
    breathing: "Exhale pressing overhead, inhale lowering.",
    tempo: "2 seconds up, 2 seconds down.",
    commonMistakes: ["Arching the lower back", "Partial range of motion", "Flaring elbows too wide"],
    safetyTips: ["Use back support to protect the lower back on heavy sets.", "Choose a weight you can control for all reps."],
    progressionTips: ["Progress to standing press for more core engagement.", "Increase weight when you can complete all reps with 1 RIR."],
    aliases: ["seated db shoulder press", "seated dumbbell press", "DB shoulder press seated", "seated OHP"],
  },
  {
    ...
    setup: [
      ...
      "Lie chest-down on the bench, dumbbells hanging at arm's length.",
    ],
    instructions: [
    ...
    execution: [
      "Keep chest in contact with the bench throughout.",
      "Avoid rotating the torso — row symmetrically.",
      "Pause at the top to maximize back contraction.",
    ],
    breathing: "Exhale rowing up, inhale lowering.",
    tempo: "2 seconds up, 1-second squeeze, 3 seconds down.",
    commonMistakes: ["Shrugging instead of retracting shoulder blades", "Using momentum", "Letting chest lift off pad"],
    safetyTips: ["The chest support eliminates lower back strain — great for beginners.", "Keep neck neutral."],
    progressionTips: ["Excellent alternative to barbell rows for those with lower back issues.", "Progress to heavier dumbbells or cable rows."],
    aliases: ["chest supported row", "incline dumbbell row", "prone dumbbell row", "supported DB row"],
  },
  {
    id: "rope-pushdown",
    ...
    setup: [
      ...
      "Stand facing the cable, grip the rope ends with a neutral grip.",
    ],
    instructions: [
      "Push the rope down and slightly apart at the bottom.",
      "Allow arms to return to about 90 degrees, keeping elbows pinned.",
    ],
    execution: [
      "Keep elbows at your sides throughout.",
      "At the bottom, spread the rope ends apart to maximize tricep contraction.",
      "Don't lean forward excessively.",
    ],
    breathing: "Exhale pressing down, inhale returning.",
    tempo: "2 seconds down, 1-second hold, 2 seconds up.",
    commonMistakes: ["Elbows drifting forward", "Leaning over the cable", "Not spreading the rope at the bottom"],
    safetyTips: ["Keep the weight moderate to maintain strict form.", "Stop if elbow pain occurs."],
    progressionTips: ["Rope attachment allows more range of motion than a bar.", "Try single-arm pushdowns for imbalance correction."],
    aliases: ["rope pushdown", "cable rope pushdown", "tricep rope extension", "rope cable pushdown"],
  },
  {
    id: "ez-bar-curl",
    name: "EZ-Bar Curl",
    ...
    difficulty: "beginner",
    setup: [
      "Grip the EZ-bar on the inner angled grips, shoulder-width apart.",
      "Stand tall with arms fully extended, bar at hip level.",
    ],
    instructions: [
    ...
    tempo: "2 seconds up, 3 seconds down.",
    commonMistakes: ["Swinging the body", "Elbows drifting forward", "Rushing the eccentric"],
    safetyTips: ["EZ-bar is more comfortable on wrists than a straight barbell.", "Use a weight you can curl with strict form."],
    progressionTips: ["Add weight when all reps are completed cleanly.", "Pair with hammer curls for full arm development."],
    aliases: ["ez bar curl", "EZ curl", "cambered bar curl", "zigzag bar curl"],
  },
  {
    ...
    setup: [
      ...
      "Let your body hang fully with legs straight.",
    ],
    instructions: [
      "Raise your knees toward your chest by flexing the hips and abs.",
      "Lower legs back to the hanging position with control.",
    ],
    execution: [
      "Avoid swinging — initiate the movement from your core, not momentum.",
      "Pause at the top when knees are at chest level.",
    ...
    commonMistakes: ["Swinging the body", "Using hip flexors only without core engagement", "Losing shoulder stability"],
    safetyTips: ["Use ab straps if grip is the limiting factor.", "Start with bent knees before progressing to straight legs."],
    progressionTips: ["Progress to hanging leg raises (straight legs) for more difficulty.", "Add a pause at the top to increase core challenge."],
    aliases: ["hanging knee raises", "knee raise hang", "hanging ab raise", "knee tuck hang"],
  },
];
